...
export default class ResourceGrid extends Component {
  ...
  static propTypes = {
    ...
    statusHeadings: React.PropTypes.array.isRequired,
  ...
  render() {
    ...
    return (
      <div className='rbc-time-view'>
        ...
        {this.renderResourceHeader(range, allDayEvents, width, this.props.statusHeadings)}
        ...
        <div ref='content' className='rbc-time-content'>
          ...
          {this.props.statusHeadings.map(resource => {
    ...
    return range.map((date, idx) => {
      let daysEvents = events.filter(
        event => dates.inRange(date,
          ...
          get(event, endAccessor), 'day') && event.statusId === id
      )
  ...
  renderResourceHeader(range, events, width, statusHeadings) {
    let { rtl } = this.props;
